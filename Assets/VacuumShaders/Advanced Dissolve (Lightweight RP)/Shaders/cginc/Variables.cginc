...
float _DissolveMainMapTiling;				uniform float _DissolveMainMapTiling_Global;
	...
	TEXTURE2D(_DissolveEdgeTexture);        SAMPLER(sampler_DissolveEdgeTexture);		
	TEXTURE2D(_DissolveEdgeTexture_Global); SAMPLER(sampler_DissolveEdgeTexture_Global);
	...
	TEXTURE2D(_DissolveMap1);        SAMPLER(sampler_DissolveMap1);			
	TEXTURE2D(_DissolveMap1_Global); SAMPLER(sampler_DissolveMap1_Global);		
	...
	TEXTURE2D(_DissolveMap2);        SAMPLER(sampler_DissolveMap2);			
	TEXTURE2D(_DissolveMap2_Global); SAMPLER(sampler_DissolveMap2_Global);
	...
	TEXTURE2D(_DissolveMap3);        SAMPLER(sampler_DissolveMap3);			
	TEXTURE2D(_DissolveMap3_Global); SAMPLER(sampler_DissolveMap3_Global);
