...
#else
	DissolveVertex2Fragment(o.clipPos, v.texcoord, v.lightmapUV.xy, o.dissolveUV);
#endif
...
#ifdef _DISSOLVEMAPPINGTYPE_TRIPLANAR
float4 dAlpha = ReadDissolveAlpha_Triplanar(IN.coords, IN.objNormal, IN.posWSShininess.xyz);
#else
float4 dAlpha = ReadDissolveAlpha(IN.uv.xy, IN.dissolveUV, IN.posWSShininess.xyz);
#endif
