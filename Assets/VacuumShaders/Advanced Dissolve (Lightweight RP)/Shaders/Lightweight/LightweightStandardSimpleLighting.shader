Shader "VacuumShaders/Advanced Dissolve/LightweightPipeline/Standard (Simple Lighting)"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "LightweightPassLitSimple.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "LightweightPassMetaSimple.hlsl"

            ENDHLSL
        }
    }
    Fallback "Hidden/InternalErrorShader"
   CustomEditor "AdvancedDissolveLightweightStandardSimpleLightingGUI"
}
