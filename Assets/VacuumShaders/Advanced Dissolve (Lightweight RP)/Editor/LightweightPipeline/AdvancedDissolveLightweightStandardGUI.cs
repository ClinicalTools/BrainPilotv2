...
internal class AdvancedDissolveLightweightStandardGUI : LightweightShaderGUI
{
    ...
    static void SetMaterialKeywords(Material material)
    {
        ...
        SetKeyword(material, "_SPECGLOSSMAP", hasGlossMap && isSpecularWorkFlow);
        SetKeyword(material, "_METALLICGLOSSMAP", hasGlossMap && !isSpecularWorkFlow);
