...
public class AdvancedDissolveLightweightStandardSimpleLightingGUI : LightweightShaderGUI
{
    ...
    public override void FindProperties(MaterialProperty[] properties)
    {
        ...
        //VacuumShaders
        AdvancedDissolveLightweighMaterialProperties.Init(properties);
    }
    ...
    public override void ShaderPropertiesGUI(Material material)
    {
        EditorGUI.BeginChangeCheck();
        {
            ...
            //VacuumShaders
            AdvancedDissolveLightweighMaterialProperties.DrawDissolveOptions(m_MaterialEditor);
            if (AdvancedDissolveLightweighMaterialProperties.foldoutUnityDefaultOptions)
            {
    ...
    private void SetMaterialKeywords(Material material)
    {
        ...
        //VacuumShaders
        AdvancedDissolveLightweighMaterialProperties.MaterialChanged(material);
    }
    ...
    private void UpdateMaterialSpecularSource(Material material)
    {
        ...
        else
        {
            ...
            SetKeyword(material, "_SPECGLOSSMAP", hasGlossMap);
            SetKeyword(material, "_SPECULAR_COLOR", !hasGlossMap);
            SetKeyword(material, "_GLOSSINESS_FROM_BASE_ALPHA", glossSource == GlossinessSource.BaseAlpha);
        }
    }
