...
public class AdvancedDissolveLightweightUnlitGUI : LightweightShaderGUI
{
    ...
    static void SetMaterialKeywords(Material material)
    {
        ...
        SetKeyword(material, "_SAMPLE_GI", sampleGI);
        SetKeyword(material, "_NORMAL_MAP", sampleGI && material.GetTexture("_BumpMap"));
