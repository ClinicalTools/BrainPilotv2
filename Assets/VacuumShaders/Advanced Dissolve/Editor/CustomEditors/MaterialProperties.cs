...
namespace VacuumShaders.AdvancedDissolve
{
    static public class MaterialProperties
    {
        ...
        static public void DrawDissolveOptions(MaterialEditor m_MaterialEditor, bool drawEmission)
        {
            ...
            {
                foldoutAdvancedDissolve = EditorGUILayout.Toggle(string.Empty, foldoutAdvancedDissolve, EditorStyles.toolbar);

                EditorGUI.LabelField(GUILayoutUtility.GetLastRect(), (foldoutAdvancedDissolve ? "▼" : "►") + " Advanced Dissolve");
            }
        ...
        static public void DrawSurfaceOptions(MaterialEditor m_MaterialEditor, bool drawBlendModes, bool drawCull)
        {
            ...
            using (new VacuumEditorGUIUtility.GUIBackgroundColor(Color.gray))
            {
                foldoutSurfaceOptions = EditorGUILayout.Toggle(string.Empty, foldoutSurfaceOptions, EditorStyles.toolbar); 

                EditorGUI.LabelField(GUILayoutUtility.GetLastRect(), (foldoutSurfaceOptions ? "▼" : "►") + " Surface Options");
            }
            if (EditorGUI.EndChangeCheck())
        ...
        static public bool DrawSurfaceInputs(MaterialEditor m_MaterialEditor)
        {
            ...
            using (new VacuumEditorGUIUtility.GUIBackgroundColor(Color.gray))
            {
                foldoutSurfaceInputs = EditorGUILayout.Toggle(string.Empty, foldoutSurfaceInputs, EditorStyles.toolbar);

                EditorGUI.LabelField(GUILayoutUtility.GetLastRect(), (foldoutSurfaceInputs ? "▼" : "►") + " Surface Inputs");

                if(foldoutSurfaceInputs)
                    GUILayout.Space(4);
            }
            if (EditorGUI.EndChangeCheck())
