...
namespace VacuumShaders.AdvancedDissolve
{
    internal class StandardShaderGUI : ShaderGUI
    {
        ...
        void DrawAdditionlaOptions(Material material)
        {
            ...
            {
                VacuumShaders.AdvancedDissolve.MaterialProperties.foldoutSurfaceOptions = EditorGUILayout.Toggle(string.Empty, VacuumShaders.AdvancedDissolve.MaterialProperties.foldoutSurfaceOptions, EditorStyles.toolbar);

                EditorGUI.LabelField(GUILayoutUtility.GetLastRect(), (VacuumShaders.AdvancedDissolve.MaterialProperties.foldoutSurfaceOptions ? "▼" : "►") + " Surface Options");
            }
            if (EditorGUI.EndChangeCheck())
