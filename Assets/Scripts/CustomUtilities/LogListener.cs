...
public class LogListener : MonoBehaviour {
	...
	private const int LOG_MESSAGE_MAX_LEN = 150;
	...
	public void ToggleScreenDraw(Text display)
	{
		...
		if (!drawToScreen) {
			...
			MonoBehaviour[] components = eventSystem.GetComponents<MonoBehaviour>();
			foreach (MonoBehaviour component in components) {
				if (component.GetType().Name.Equals("OVRInputModule")) {
